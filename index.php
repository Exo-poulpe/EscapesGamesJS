...
<table border="solid" id="TableHex1" class="Table">
  <tr>
    ...
    for ($i=0; $i < 2; $i++) {if ($i == 1) {
      print('</tr></table><table border="solid" id="TableHex2" class="Table"><tr>');
    } ?>
    <td>
...
<form method="post" action="serveur.php">
  <input type="Button" value="0" name="Button" onclick="ListSetter(0)" id="B0" class="Button btn btn-secondary"/>
  <input type="Button" value="1" name="Button" onclick="ListSetter(1)" id="B1" class="Button btn btn-secondary"/>
  <input type="Button" value="X" name="Delete" onclick="ResetArray()" id="X" class="Button btn btn-secondary"/>
</form>
